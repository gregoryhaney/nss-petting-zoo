...
class CowRefactored():
    ...
    # refactor COW as a child class by adding (Animal)
class Cow(Animal):
    #remove redundant properties and set values via Animal
    def __init__(self, name, species, shift, food, chip_num):
        super().__init__(name, species, food, chip_num)
        self.shift = shift   # stays on COW because not all animals have shifts
        self.walking = True  # Stays on COW: not all animals 'walk'
